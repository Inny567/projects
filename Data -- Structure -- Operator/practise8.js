...
// console.log('Emmanuel Inioluwa'.split(' '));

// const [firstName, lastName] = 'Emmanuel Inioluwa'.split(' ');
...
// console.log(maskCreditCard(983756726375735));
// console.log(maskCreditCard(68346537357836));
// console.log(maskCreditCard(4526725782547254));
